class ContactsController < ApplicationController
  ...
  # GET /contacts/1
  def show
    render json: @contact, include: :kind#, meta: { author: "Veloso"} #include: [:kind, :address, :phones] #{name: @contact.name, birthdate: (I18n.l(@contact.birthdate) unless @contact.birthdate.blank?) } #, include: :kind
  end
